...
apply_world_border() {
    ...
    send_and_wait "worldborder center $center_x $center_z" 'world border.*(center| to )' 300 >/dev/null
    send_and_wait "worldborder set $((radius_chunks * 32))" 'world border.*block\(s\) wide|world border.*size' 300
}
