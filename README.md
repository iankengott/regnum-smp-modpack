...
Canonical NeoForge modpack manifest, configuration, compatibility matrix, and
distribution project for the Regnum SMP.

Repository: [iankengott/regnum-smp-modpack](https://github.com/iankengott/regnum-smp-modpack)
Main-PC checkout: `/home/iank/Desktop/my mods/mods-editing/regnum-smp-modpack`
...
- Shader/Create compatibility, performance profiles, and pack-level configuration.
